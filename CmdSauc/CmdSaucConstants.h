// CmdSaucConstants.h
#ifndef CMDSAUCCONSTANTS_H
#define CMDSAUCCONSTANTS_H
...
class CmdSaucConstants : public BaseControlVariables {
public:

   friend std::ostream& operator<< (std::ostream& os, const CmdSaucConstants& csc) {
...
private:
   ...
   // File prefix member
   std::string prefix = "SAUC";


};

#endif // CMDSAUCCONSTANTS_H
