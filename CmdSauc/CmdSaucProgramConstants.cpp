...
#include <set>
   ...
   std::string CmdSaucProgramConstants::Centering = LRL_StringTools::strToupper( "P" );
   double CmdSaucProgramConstants::A = 100.;
   double CmdSaucProgramConstants::B = 100.;
   double CmdSaucProgramConstants::C = 100.;
   double CmdSaucProgramConstants::Alpha = 90.;
   double CmdSaucProgramConstants::Beta = 90.;
   double CmdSaucProgramConstants::Gamma = 90.;
   //std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "L1" ); /*1*/
   //std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "L2" ); /*2*/
   //std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "NCDist" ); /*3*/
   //std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "V7" ); /*4*/
   //std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "D7" ); /*5*/
   //std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "S6" ); /*6*/
   std::string CmdSaucProgramConstants::Algorithm = LRL_StringTools::strToupper( "DC7unsrt" );/*7*/
   int CmdSaucProgramConstants::NumHits = 50;
   //std::string CmdSaucProgramConstants::Similarity = LRL_StringTools::strToupper( "Nearest" );/*1*/
   std::string CmdSaucProgramConstants::Similarity = LRL_StringTools::strToupper( "Sphere" );/*2*/
   //std::string CmdSaucProgramConstants::Similarity = LRL_StringTools::strToupper( "Range" );/*3*/
   std::string CmdSaucProgramConstants::SortbyFam = LRL_StringTools::strToupper( "yes" );/*yes or no*/
   std::string CmdSaucProgramConstants::UsePercent = LRL_StringTools::strToupper( "yes" );/*yes or no*/
   double CmdSaucProgramConstants::RangeA = 1.;
   double CmdSaucProgramConstants::RangeB = 1.;
   double CmdSaucProgramConstants::RangeC = 1.;
   double CmdSaucProgramConstants::RangeAlpha = 0.15;
   double CmdSaucProgramConstants::RangeBeta = 0.15.;
   double CmdSaucProgramConstants::RangeGamma = 0.15.;
